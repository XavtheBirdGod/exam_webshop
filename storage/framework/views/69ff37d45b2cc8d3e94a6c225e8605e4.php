    ...
    <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div class="flex gap-4 items-center text-[#e8e4df]">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.outside="open = false" class="absolute right-0 mt-2 w-48 bg-[#161615] border border-white/10 rounded-2xl py-2 shadow-lg z-50">
                        <div class="px-4 py-2 border-b border-white/5">
                            ...
                            <p class="text-sm font-semibold text-[#e8e4df] truncate"><?php echo e(auth()->user()->name); ?></p>
                        </div>
            ...
            <a href="/cart" wire:navigate class="px-6 py-2 rounded-full bg-[#d4a574] text-[#0f0f0f] font-semibold text-sm hover:brightness-110 active:scale-95 transition-all">
                Cart (<?php echo e($cartCount); ?>)
            </a>
        </div>
    </div>
</nav><?php /**PATH C:\wamp64\www\exam_webshop\storage\framework\views/livewire/views/c017e3ea.blade.php ENDPATH**/ ?>