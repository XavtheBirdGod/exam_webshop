...
<div class="min-h-[80dvh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" x-data="{ showLogin: true }">
    <div class="max-w-md w-full relative">
        ...
        <div x-show="showLogin" 
             ...
             class="w-full space-y-8 bg-white/5 p-10 rounded-[2rem] border border-white/10 backdrop-blur-xl absolute top-0 left-0"
             :class="{ 'relative': showLogin, 'absolute': !showLogin }"
            ...
            <div>
                ...
                <p class="mt-2 text-center text-sm text-[#9a9590]">
                    Or <button type="button" @click="showLogin = false" class="font-medium text-[#c9b896] hover:text-[#d4a574] transition-colors">create a new account</button>
                </p>
            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-[#c9b896] hover:text-[#d4a574] font-accent uppercase tracking-widest transition-colors">Forgot password?</a>
                    </div>
                </div>
        ...
        <div x-cloak x-show="!showLogin" 
             ...
             :class="{ 'relative': !showLogin, 'absolute': showLogin }">
            <div>
                <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-[#d4a574]">Create an Account</h2>
                <p class="mt-2 text-center text-sm text-[#9a9590]">
                    Or <button type="button" @click="showLogin = true" class="font-medium text-[#c9b896] hover:text-[#d4a574] transition-colors">sign in to your account</button>
                </p>
            </div>
