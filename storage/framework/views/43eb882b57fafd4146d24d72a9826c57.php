        ...
        <div class="flex flex-col md:flex-row gap-6 justify-between items-stretch md:items-center mb-12 border-b border-white/5 pb-8">
            ...
            <div class="flex flex-wrap gap-2 items-center">
                <button 
                    ...
                    class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all <?php echo e(is_null($selectedCategory) ? 'bg-[#d4a574] text-[#0f0f0f]' : 'border border-white/10 text-[#e8e4df] hover:bg-white/5'); ?>"
                >
                    All (<?php echo e($totalProductCount); ?>)
                </button>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button 
                        ...
                        class="px-5 py-2.5 rounded-full text-sm font-semibold transition-all <?php echo e($selectedCategory === $category->id ? 'bg-[#d4a574] text-[#0f0f0f]' : 'border border-white/10 text-[#e8e4df] hover:bg-white/5'); ?>"
                    >
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->isNotEmpty()): ?>
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="<?php echo e($colSpan); ?> relative overflow-hidden bg-[#161615] rounded-[32px] border <?php echo e($borderColor); ?> p-6 md:p-8 flex flex-col justify-between group hover:border-[#d4a574]/40 transition-all duration-300 transform hover:-translate-y-1 min-h-[360px]">
                        <!-- Product Background Cover -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo e($product->getImageUrl()); ?>" alt="" class="w-full h-full object-cover opacity-10 group-hover:scale-105 transition-transform duration-700">
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-between flex-grow">
                            ...
                            <div class="flex items-center justify-between gap-4 mt-auto">
                                ...
                                <a href="<?php echo e(route('shop.product-detail', $product)); ?>" class="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-[#d4a574] text-[#0f0f0f] font-bold text-xs hover:brightness-110 active:scale-95 transition-all">
                                    Discover
                                </a>
                            </div>
                        </div>
...
</div><?php /**PATH C:\wamp64\www\exam_webshop\storage\framework\views/livewire/views/1b3458e0.blade.php ENDPATH**/ ?>