                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="py-6">
                                    <div class="flex flex-col">
                                        <span class="font-bold text-[#e8e4df]"><?php echo e($order->shipping_address['first_name'] ?? ''); ?> <?php echo e($order->shipping_address['last_name'] ?? ''); ?></span>
                                        <span class="text-xs text-[#9a9590]"><?php echo e($order->email); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="py-6">
                                    ...
                                    <?php else: ?>
                                        <span class="inline-flex items-center gap-1.5 text-xs font-semibold text-[#9a9590]">
                                            <span class="w-1.5 h-1.5 rounded-full bg-[#9a9590]"></span> <?php echo e(ucfirst($order->status)); ?>

                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="py-6 text-right">
                                    <a href="<?php echo e(route('seller.orders.detail', $order)); ?>" wire:navigate class="px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 text-[#e8e4df] transition-colors text-xs font-semibold uppercase tracking-wider">
                                        View
                                    </a>
                                </td>
                            </tr>
...
</div><?php /**PATH C:\wamp64\www\exam_webshop\resources\views/components/seller/orders/⚡index.blade.php ENDPATH**/ ?>