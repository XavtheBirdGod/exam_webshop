                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors">
                                <td class="py-6 pr-4">
                                    <div class="flex items-center gap-4">
                                        <img src="<?php echo e($product->getImageUrl()); ?>" alt="<?php echo e($product->name); ?>" class="w-12 h-12 rounded-xl object-cover border border-white/10 bg-white/5">
                                        <div>
                                            <h4 class="font-bold text-base text-[#e8e4df]"><?php echo e($product->name); ?></h4>
                                            <p class="text-xs text-[#9a9590] mt-1 truncate max-w-xs"><?php echo e($product->slug); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-6">
                                ...
                                <td class="py-6">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        ?>
                                        <span class="font-semibold <?php echo e($totalStock < 5 ? 'text-[#e8b4b8]' : 'text-[#e8e4df]'); ?>">
                                            <?php echo e($totalStock); ?> available
                                        </span>
                                        <span class="text-xs text-[#9a9590]">
                                            Across <?php echo e($product->variants->count()); ?> variants
                                        </span>
                                    </div>
                                </td>
                                <td class="py-6 text-right">
                                    <div class="flex justify-end gap-3">
                                        <a href="/seller/products/<?php echo e($product->slug); ?>/edit" class="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-[#c9b896] hover:text-[#d4a574] transition-colors" title="Edit Product">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </a>
                                        <button wire:click="deleteProduct(<?php echo e($product->id); ?>)" wire:confirm="Are you sure you want to delete this product and all its variants?" class="p-2 rounded-lg bg-white/5 hover:bg-red-500/10 text-[#9a9590] hover:text-red-400 transition-colors" title="Delete Product">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
</div><?php /**PATH C:\wamp64\www\exam_webshop\storage\framework\views/livewire/views/5610c2f7.blade.php ENDPATH**/ ?>