...
<div class="relative min-h-[80dvh] flex items-center justify-center overflow-hidden">
    ...
    <div id="collection" class="relative z-10 max-w-4xl mx-auto px-6 text-center scroll-mt-24">
        ...
        <div class="flex flex-col md:flex-row gap-6 justify-center items-center">
            <a href="#collection" class="inline-flex items-center justify-center px-10 py-4 rounded-full bg-[#d4a574] text-[#0f0f0f] font-bold text-lg hover:brightness-110 active:scale-95 transition-all">
                Shop Collection
            </a>
