                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="py-6 text-right">
                                    <div class="flex justify-end gap-3">
                                        <a href="/seller/products/{{ $product->slug }}/edit" class="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-[#c9b896] hover:text-[#d4a574] transition-colors" title="Edit Product">
